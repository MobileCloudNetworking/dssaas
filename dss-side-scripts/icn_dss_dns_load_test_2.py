...
def main(argv):
    try:
        opts, args = getopt.getopt(argv,"hu:i:c:f:p:q:",["url=","icn=","icount=","file_path=","prefix=","dns_qps="])
    except getopt.GetoptError:
        print ("Usage: python icn_dss_dns_load_test.py -u <URL_TO_POLL_FROM> -i <ICN_API_URL> -c [Number of desired interests per sec: 300] -f [PATH_TO_SAVE-FILES default: ./] -p [ICN_PREFIX default: /dss] -q [dns_qps]")
        sys.exit(0)
